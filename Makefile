...
CCFLAGS   += -fno-builtin -fpack-struct -m32 -std=gnu99 -mregparm=3 -Iinclude/ -W -Wall -fstrict-aliasing -fomit-frame-pointer -minline-all-stringops -Winline  --param max-inline-insns-single=50
