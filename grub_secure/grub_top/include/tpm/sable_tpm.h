...
typedef struct {
    TPM_AUTHHANDLE authHandle; //4
    TPM_NONCE nonceOdd; //20
    TPM_BOOL continueAuthSession; //1
    TPM_AUTHDATA pubAuth; //20
} SessionEnd;
...
TPM_RESULT TPM_Unseal( BYTE *buffer, BYTE *inData, BYTE *secretData, UINT32 secretDataBufSize, UINT32 *secretDataSize, SessionCtx * sctxParent, SessionCtx * sctxEntity, TPM_AUTHDATA *dataHash, TPM_AUTHDATA *srkHash);
