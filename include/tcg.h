...
typedef struct tdTPM_DIGEST { BYTE digest[TPM_SHA1_160_HASH_LEN]; } TPM_DIGEST;
...
typedef struct tdTPM_FAMILY_LABEL { BYTE label; } TPM_FAMILY_LABEL;
...
typedef struct tdTPM_DELEGATE_LABEL { BYTE label; } TPM_DELEGATE_LABEL;
