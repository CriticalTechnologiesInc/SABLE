...
DECLARE_STRING(.slb.end_of_low);
DECLARE_STRING(.slb.aligned_end_of_low);
DECLARE_STRING(.slb.start_of_high);
DECLARE_STRING(.slb.end_of_high);
...
DECLARE_STRING(Erasing_owner_authdata);
...
DECLARE_STRING(PCR[17]:);
DECLARE_STRING(calc_hash_failed);
DECLARE_STRING(PCR[19]:);
DECLARE_STRING(Sealing_passPhrase);
DECLARE_STRING(to_PCR[19]_with_value);
DECLARE_STRING(enter_ownerAuthData);
DECLARE_STRING(tis_deactivate_failed);
